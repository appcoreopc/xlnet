...
def main(_):
  ...
  if FLAGS.do_predict:
    tf.logging.info("Do prediction configured!")
    ...
    tf.logging.info("eval file")
    tf.logging.info(eval_rec_file)
    ...
    if tf.gfile.Exists(eval_rec_file) and tf.gfile.Exists(
      ...
      tf.logging.info("about to run convert_examples_to_features")   
      convert_examples_to_features(
    ...
    tf.logging.info("about to run input_fn_builder")   
